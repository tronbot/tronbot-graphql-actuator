...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "graphqlActuator@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "graphqlActuator API";

        private String description = "graphqlActuator API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "graphqlActuator";
